...
const FeedbackForm = () => {
 ...
 const handleSubmitReview = async e =>{
  ...
  return <form action="">
    ...
    <textarea className=' border border-solid border-[#0066ff34] focus:outline outline-primaryColor w-full px-4 py-3 rounded-md ' rows="5"  placeholder='Write Your message' onClick={()=> setReviewText(e.target.value)}></textarea>
