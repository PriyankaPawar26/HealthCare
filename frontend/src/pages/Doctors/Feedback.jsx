...
const  Feedback = () => {
 ...
 <div>
    <h5 className='text-[16] leading-6 text-primaryColor font-bold'>Jahan</h5> 
    <p className='text-[14px] leading-6 text-primaryColor font-bold'> {formateDate("02-14-2023")} </p>
    <p className='text__para mt-3 font-medium mt-2 font-medium text-[15px]'> Good Service, highly recommended 👍</p>
 </div>
   </div>
